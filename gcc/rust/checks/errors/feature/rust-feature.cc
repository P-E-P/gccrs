...
#define ISSUE_NONE gcc::nullopt
#define EDITION_2018 Edition::E2018
#define EDITION_NONE gcc::nullopt
#define REASON_SOME(r) r
#define REASON_NONE gcc::nullopt
...
#define FEATURE_ACTIVE(a, b, c, d, edition)                                    \
  FEATURE_BASE (ACTIVE, a, b, c, d, edition, gcc::nullopt)

#define FEATURE_ACCEPTED(a, b, c, d)                                           \
  FEATURE_BASE (ACCEPTED, a, b, c, d, gcc::nullopt, gcc::nullopt)

#define FEATURE_REMOVED(a, b, c, d, reason)                                    \
  FEATURE_BASE (REMOVED, a, b, c, d, gcc::nullopt, reason)
